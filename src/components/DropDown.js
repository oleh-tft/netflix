...
export function DropDown(props) {
    ...
    return (
        <div className='formwrapper'>
            {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img" viewBox="0 0 16 16" width="16" height="16" dataIcon="LanguagesSmall" className='svglang'>
            ...
            <select name='langselect' className='comp'>
                <option lang="uk" label="Українська" value="uk-UA">Українська</option>
                <option lang="en" label="English" value="en-UA">English</option>
            </select>
        </div>
